$("#signin-link").on("click", function (event) {
    modal("<p>Login or Register with:</p>              <button type='button' class='btn btn-default' id='login-btn'>Login</button>            <button type='button' class='btn btn-default' id='signup-btn'>Sign-Up</button>");
})
//Login Screen
